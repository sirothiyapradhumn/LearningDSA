...
public class l001 {
    ...
    public static int subSequanceBottomUp( String str,  String ans) {
        if(str.length() == 0) {
        ...
        int count = 0;
        count += subSequance(str.substring(1), ans+str.charAt(0));
        count += subSequance(str.substring(1), ans);
        
        return count;
    }

    public static int subSequanceBottomUp1( String str, int idx,  String ans) {
        if(idx == str.length()) {
            System.out.println(ans);
            return 1;
        }
        ...
        int count = 0;
        count += subSequance(str, idx+1, ans+str.charAt(idx));
        count += subSequance(str, idx+1, ans);
    ...
    public static int decodeWays(String str, int idx, String ans) {
        ...
        if (idx < str.length() - 1) {
            ...
            if (num <= 26) {
                count += decodeWays(str, idx + 2, ans + (char) (num - 1 + 'a'));
            }
        }
